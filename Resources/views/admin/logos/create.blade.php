...
@section('content')
    ...
    <div class="col-xs-12 p-0">
        <form class="my-form" action="{{ route('admin.logos.store', ['path' => $path]) }}" method="POST" data-form-type="store" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2" name="main_position">
                                <option value="{{ Logo::LOGOS_AFTER_DESCRIPTION }}">{{ trans('logos::admin.logos.after_main_description') }}</option>
                                <option value="{{ Logo::LOGOS_AFTER_ADDITIONAL_DESCRIPTION_1 }}">{{ trans('logos::admin.logos.after_additional_description_1') }}</option>
                                <option value="{{ Logo::LOGOS_AFTER_ADDITIONAL_DESCRIPTION_2 }}">{{ trans('logos::admin.logos.after_additional_description_2') }}</option>
                                <option value="{{ Logo::LOGOS_AFTER_ADDITIONAL_DESCRIPTION_3 }}">{{ trans('logos::admin.logos.after_additional_description_3') }}</option>
                                <option value="{{ Logo::LOGOS_AFTER_ADDITIONAL_DESCRIPTION_4 }}">{{ trans('logos::admin.logos.after_additional_description_4') }}</option>
                                <option value="{{ Logo::LOGOS_AFTER_ADDITIONAL_DESCRIPTION_5 }}">{{ trans('logos::admin.logos.after_additional_description_5') }}</option>
                                <option value="{{ Logo::LOGOS_AFTER_ADDITIONAL_DESCRIPTION_6 }}">{{ trans('logos::admin.logos.after_additional_description_6') }}</option>
                            </select>
                        </div>
                    </div>
